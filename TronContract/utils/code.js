...
function bin2String(array) {
    ...
    return bytesUtil.bytesToString(array);
}
...
function byte2hexStr(){
    return bytesUtil.byte2hexStr()
}
function bytesToString(){
    return bytesUtil.bytesToString()
}
function hextoString(){
    return bytesUtil.hextoString()
}
function byteArray2hexStr(){
    return bytesUtil.byteArray2hexStr()
}
function base64DecodeFromString(){
    return bytesUtil.base64DecodeFromString()
}
function base64EncodeToString(){
    return bytesUtil.base64EncodeToString()
}
